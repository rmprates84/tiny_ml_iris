...
#define IRIS_NUM_SAMPLES   150
#define IRIS_NUM_FEATURES  4
#define IRIS_NUM_CLASSES   3

// -----------------------------
// Dataset Iris - Features (150 × 4)
// -----------------------------
static const float iris_features[IRIS_NUM_SAMPLES][IRIS_NUM_FEATURES] = {
    // Setosa 50 samples
    ...
    {5.5f,3.5f,1.3f,0.2f},{4.9f,3.6f,1.4f,0.1f},{4.4f,3.0f,1.3f,0.2f},
...
// Labels (0,1,2)
// -----------------------------
static const int iris_labels[IRIS_NUM_SAMPLES] = {
    // 50 Setosa
